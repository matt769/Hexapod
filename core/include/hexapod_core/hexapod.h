...
class Hexapod {
 public:
  ...
  enum class State { UNSUPPORTED, STANDING, RAISING, WALKING, LOWERING, FULL_MANUAL };
  ...
  bool increaseStanceWidth();
  bool decreaseStanceWidth();
  ...
  bool increaseFootGroundTravelRatio();
  bool decreaseFootGroundTravelRatio();
  ...
  int16_t getMovementNumIncrements() const;
 ...
 private:
  ...
  float base_height_, body_height_;
