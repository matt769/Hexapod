...
TEST_CASE("Joint builder offset flip") {
  ...
  auto jp = JointBuilder(offset, flip)
                ...
                .setPhysicalAngle(starting_physical_angle)
                .create();
  ...
  auto jm = JointBuilder(offset, flip)
                ...
                .setModelAngle(starting_model_angle)
                .create();
  ...
  auto jp2 = Joint::createFromPhysicalAngles(physical_lower_limit, physical_upper_limit, starting_physical_angle,
                                             offset, flip);
...
TEST_CASE("Joint limits") {
  const std::vector<JointLimitTest> joint_definitions = {
      {-50, 100, 0, false, -50, 100}, {50, 100, 0, false, 50, 100},   {-50, 100, 0, true, -100, 50},
      {50, 100, 0, true, -100, -50},  {-50, 100, 20, false, -70, 80}, {50, 100, 20, false, 30, 80},
      {-50, 100, 20, true, -80, 70},  {50, 100, 20, true, -80, -30},
  };
